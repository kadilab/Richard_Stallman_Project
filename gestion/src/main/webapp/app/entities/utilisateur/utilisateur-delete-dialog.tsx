...
export const UtilisateurDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gestionCommerceApp.utilisateur.delete.question">
        <Translate contentKey="gestionCommerceApp.utilisateur.delete.question" interpolate={{ id: utilisateurEntity.id }}>
