...
export const ProduitDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gestionCommerceApp.produit.delete.question">
        <Translate contentKey="gestionCommerceApp.produit.delete.question" interpolate={{ id: produitEntity.id }}>
