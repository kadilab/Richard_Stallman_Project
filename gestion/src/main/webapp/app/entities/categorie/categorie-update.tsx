...
export const CategorieUpdate = () => {
  ...
  const handleClose = () => {
    navigate('/categorie' + location.search);
  };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gestionCommerceApp.categorie.home.createOrEditLabel" data-cy="CategorieCreateUpdateHeading">
            <Translate contentKey="gestionCommerceApp.categorie.home.createOrEditLabel">Create or edit a Categorie</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gestionCommerceApp.categorie.nom')}
                id="categorie-nom"
                name="nom"
                data-cy="nom"
                type="text"
