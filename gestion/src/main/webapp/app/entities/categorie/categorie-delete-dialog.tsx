...
export const CategorieDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gestionCommerceApp.categorie.delete.question">
        <Translate contentKey="gestionCommerceApp.categorie.delete.question" interpolate={{ id: categorieEntity.id }}>
