...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOURNISSEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_FOURNISSEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOURNISSEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOURNISSEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOURNISSEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOURNISSEUR actions', async () => {
      const expectedActions = [
        {
