...
export const CommandeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gestionCommerceApp.commande.delete.question">
        <Translate contentKey="gestionCommerceApp.commande.delete.question" interpolate={{ id: commandeEntity.id }}>
