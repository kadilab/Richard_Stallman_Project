...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUITCOMMANDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUITCOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUITCOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUITCOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUITCOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUITCOMMANDE actions', async () => {
      const expectedActions = [
        {
