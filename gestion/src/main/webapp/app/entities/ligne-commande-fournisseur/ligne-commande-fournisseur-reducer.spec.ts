...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ligne-commande-fournisseur.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIGNECOMMANDEFOURNISSEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIGNECOMMANDEFOURNISSEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIGNECOMMANDEFOURNISSEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIGNECOMMANDEFOURNISSEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIGNECOMMANDEFOURNISSEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIGNECOMMANDEFOURNISSEUR actions', async () => {
      const expectedActions = [
        {
