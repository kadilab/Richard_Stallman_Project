...
/**
 * REST controller for managing {@link com.kadilab.com.mycompany.myapp.domain.CommandeFournisseur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CommandeFournisseurResource {
    ...
    public ResponseEntity<CommandeFournisseur> partialUpdateCommandeFournisseur(
        ...
        Optional<CommandeFournisseur> result = commandeFournisseurRepository
            ...
            .map(existingCommandeFournisseur -> {
                if (commandeFournisseur.getNumero() != null) {
                    existingCommandeFournisseur.setNumero(commandeFournisseur.getNumero());
                }
                if (commandeFournisseur.getDateDebut() != null) {
                    existingCommandeFournisseur.setDateDebut(commandeFournisseur.getDateDebut());
                }
                if (commandeFournisseur.getDateFin() != null) {
                    existingCommandeFournisseur.setDateFin(commandeFournisseur.getDateFin());
                }
                if (commandeFournisseur.getStatut() != null) {
                    existingCommandeFournisseur.setStatut(commandeFournisseur.getStatut());
                }
    ...
    public ResponseEntity<List<CommandeFournisseur>> getAllCommandeFournisseurs(
        ...
        Page<CommandeFournisseur> page = commandeFournisseurRepository.findAll(pageable);
