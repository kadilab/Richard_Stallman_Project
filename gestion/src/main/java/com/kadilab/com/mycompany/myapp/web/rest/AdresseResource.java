...
/**
 * REST controller for managing {@link com.kadilab.com.mycompany.myapp.domain.Adresse}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AdresseResource {
        ...
        Optional<Adresse> result = adresseRepository
            ...
            .map(existingAdresse -> {
                ...
                if (adresse.getCommune() != null) {
                    existingAdresse.setCommune(adresse.getCommune());
                }
     ...
     */
    @GetMapping("/adresses")
    public ResponseEntity<List<Adresse>> getAllAdresses(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
