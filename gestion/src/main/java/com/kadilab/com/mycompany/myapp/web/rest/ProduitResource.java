...
/**
 * REST controller for managing {@link com.kadilab.com.mycompany.myapp.domain.Produit}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Produit> partialUpdateProduit(
        ...
        Optional<Produit> result = produitRepository
            ...
            .map(existingProduit -> {
                ...
                if (produit.getSeuilReapprovisionnement() != null) {
                    existingProduit.setSeuilReapprovisionnement(produit.getSeuilReapprovisionnement());
                }
