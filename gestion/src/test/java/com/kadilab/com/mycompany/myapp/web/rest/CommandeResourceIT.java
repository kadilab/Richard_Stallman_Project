...
import com.kadilab.com.mycompany.myapp.repository.CommandeRepository;
...
class CommandeResourceIT {
    ...
    private static final Float UPDATED_REMISE = 2F;

    private static final STATUS DEFAULT_STATUT = STATUS.PENDING;
    private static final STATUS UPDATED_STATUT = STATUS.SEND;
    ...
    public static Commande createEntity(EntityManager em) {
        Commande commande = new Commande().date(DEFAULT_DATE).remise(DEFAULT_REMISE).statut(DEFAULT_STATUT);
        return commande;
    }
    ...
    public static Commande createUpdatedEntity(EntityManager em) {
        Commande commande = new Commande().date(UPDATED_DATE).remise(UPDATED_REMISE).statut(UPDATED_STATUT);
        return commande;
    }
    ...
    void createCommande() throws Exception {
        ...
        assertThat(testCommande.getRemise()).isEqualTo(DEFAULT_REMISE);
    ...
    void putExistingCommande() throws Exception {
        ...
        updatedCommande.date(UPDATED_DATE).remise(UPDATED_REMISE).statut(UPDATED_STATUT);
        ...
        assertThat(testCommande.getRemise()).isEqualTo(UPDATED_REMISE);
    ...
    void fullUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.date(UPDATED_DATE).remise(UPDATED_REMISE).statut(UPDATED_STATUT);
