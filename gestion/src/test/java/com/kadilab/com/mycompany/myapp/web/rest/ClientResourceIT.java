...
import com.kadilab.com.mycompany.myapp.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getPostnom()).isEqualTo(DEFAULT_POSTNOM);
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.nom(UPDATED_NOM).postnom(UPDATED_POSTNOM).prenom(UPDATED_PRENOM).numero(UPDATED_NUMERO).email(UPDATED_EMAIL);
        ...
        assertThat(testClient.getPostnom()).isEqualTo(UPDATED_POSTNOM);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.nom(UPDATED_NOM).postnom(UPDATED_POSTNOM).prenom(UPDATED_PRENOM);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.nom(UPDATED_NOM).postnom(UPDATED_POSTNOM).prenom(UPDATED_PRENOM).numero(UPDATED_NUMERO).email(UPDATED_EMAIL);
