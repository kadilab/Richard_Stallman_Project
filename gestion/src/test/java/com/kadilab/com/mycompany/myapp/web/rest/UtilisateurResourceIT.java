...
import com.kadilab.com.mycompany.myapp.domain.Utilisateur;
import com.kadilab.com.mycompany.myapp.repository.UtilisateurRepository;
...
class UtilisateurResourceIT {
    ...
    public static Utilisateur createEntity(EntityManager em) {
        Utilisateur utilisateur = new Utilisateur().nom(DEFAULT_NOM).adresse(DEFAULT_ADRESSE).email(DEFAULT_EMAIL);
        return utilisateur;
    }
    ...
    public static Utilisateur createUpdatedEntity(EntityManager em) {
        Utilisateur utilisateur = new Utilisateur().nom(UPDATED_NOM).adresse(UPDATED_ADRESSE).email(UPDATED_EMAIL);
        return utilisateur;
    }
    ...
    void putExistingUtilisateur() throws Exception {
        ...
        updatedUtilisateur.nom(UPDATED_NOM).adresse(UPDATED_ADRESSE).email(UPDATED_EMAIL);
    ...
    void fullUpdateUtilisateurWithPatch() throws Exception {
        ...
        partialUpdatedUtilisateur.nom(UPDATED_NOM).adresse(UPDATED_ADRESSE).email(UPDATED_EMAIL);
