...
import com.kadilab.com.mycompany.myapp.domain.Adresse;
import com.kadilab.com.mycompany.myapp.repository.AdresseRepository;
...
class AdresseResourceIT {
    ...
    void putExistingAdresse() throws Exception {
        ...
        updatedAdresse.numero(UPDATED_NUMERO).rue(UPDATED_RUE).commune(UPDATED_COMMUNE).ville(UPDATED_VILLE).pays(UPDATED_PAYS);
    ...
    void partialUpdateAdresseWithPatch() throws Exception {
        ...
        partialUpdatedAdresse.numero(UPDATED_NUMERO).rue(UPDATED_RUE).commune(UPDATED_COMMUNE).ville(UPDATED_VILLE);
    ...
    void fullUpdateAdresseWithPatch() throws Exception {
        ...
        partialUpdatedAdresse.numero(UPDATED_NUMERO).rue(UPDATED_RUE).commune(UPDATED_COMMUNE).ville(UPDATED_VILLE).pays(UPDATED_PAYS);
