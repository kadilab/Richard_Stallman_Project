...
import com.kadilab.com.mycompany.myapp.domain.Produit;
import com.kadilab.com.mycompany.myapp.repository.ProduitRepository;
...
class ProduitResourceIT {
    ...
    private static final Integer DEFAULT_SEUIL_REAPPROVISIONNEMENT = 1;
    private static final Integer UPDATED_SEUIL_REAPPROVISIONNEMENT = 2;
    ...
    public static Produit createEntity(EntityManager em) {
        Produit produit = new Produit()
            ...
            .seuilReapprovisionnement(DEFAULT_SEUIL_REAPPROVISIONNEMENT);
        return produit;
    }
    ...
    public static Produit createUpdatedEntity(EntityManager em) {
        Produit produit = new Produit()
            ...
            .seuilReapprovisionnement(UPDATED_SEUIL_REAPPROVISIONNEMENT);
        return produit;
    }
    ...
    void createProduit() throws Exception {
        ...
        assertThat(testProduit.getSeuilReapprovisionnement()).isEqualTo(DEFAULT_SEUIL_REAPPROVISIONNEMENT);
    }
    ...
    void getAllProduits() throws Exception {
        ...
        restProduitMockMvc
            ...
            .andExpect(jsonPath("$.[*].seuilReapprovisionnement").value(hasItem(DEFAULT_SEUIL_REAPPROVISIONNEMENT)));
    }
    ...
    void getProduit() throws Exception {
        ...
        restProduitMockMvc
            ...
            .andExpect(jsonPath("$.seuilReapprovisionnement").value(DEFAULT_SEUIL_REAPPROVISIONNEMENT));
    }
    ...
    void putExistingProduit() throws Exception {
        ...
        assertThat(testProduit.getSeuilReapprovisionnement()).isEqualTo(UPDATED_SEUIL_REAPPROVISIONNEMENT);
    }
