...
describe('Commande e2e test', () => {
  ...
  describe('new Commande page', () => {
    ...
    it('should create an instance of Commande', () => {
      cy.get(`[data-cy="date"]`).type('2023-05-30T20:19').blur().should('have.value', '2023-05-30T20:19');

      cy.get(`[data-cy="remise"]`).type('76535').should('have.value', '76535');

      cy.get(`[data-cy="statut"]`).select('PENDING');
