...
describe('Produit e2e test', () => {
  ...
  describe('new Produit page', () => {
    ...
    it('should create an instance of Produit', () => {
      cy.get(`[data-cy="reference"]`).type('Web Proactive').should('have.value', 'Web Proactive');
      ...
      cy.get(`[data-cy="quantiteStock"]`).type('41277').should('have.value', '41277');

      cy.get(`[data-cy="seuilReapprovisionnement"]`).type('25616').should('have.value', '25616');
