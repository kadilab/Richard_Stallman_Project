...
describe('Utilisateur e2e test', () => {
        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/api/utilisateurs?page=0&size=20>; rel="last",<http://localhost/api/utilisateurs?page=0&size=20>; rel="first"',
              },
              body: [utilisateur],
            }
  ...
  describe('new Utilisateur page', () => {
    ...
    it('should create an instance of Utilisateur', () => {
      cy.get(`[data-cy="nom"]`).type('primary connect Maryland').should('have.value', 'primary connect Maryland');

      cy.get(`[data-cy="adresse"]`).type('bricks-and-clicks neural').should('have.value', 'bricks-and-clicks neural');

      cy.get(`[data-cy="email"]`).type('Simeon36@hotmail.com').should('have.value', 'Simeon36@hotmail.com');
